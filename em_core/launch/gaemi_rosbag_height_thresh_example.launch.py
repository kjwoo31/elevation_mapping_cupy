...
def generate_launch_description():
    ...
    em_node = Node(
        ...
        parameters=[em_param_dir, {'publishers.pub_list': ['height_thresh']}])
    ...
    # RViz 시각화
    rviz_config_dir = os.path.join(get_package_share_directory('em_core'), 'rviz2',
                                   'gaemi_rosbag_height_thresh.rviz')
    rviz_node = Node(
        package='rviz2',
        executable='rviz2',
        name='rviz2',
